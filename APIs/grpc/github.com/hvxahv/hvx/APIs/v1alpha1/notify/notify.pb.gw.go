...
func RegisterNotifyHandlerServer(ctx context.Context, mux *runtime.ServeMux, server NotifyServer) error {
	...
	mux.Handle("POST", pattern_Notify_Subscribe_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/hvx.api.v1alpha1.notify.proto.Notify/Subscribe", runtime.WithHTTPPathPattern("/api/v1/notify/subscribe"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Notify_Subscribe_0(ctx, inboundMarshaler, server, req, pathParams)
		...
		forward_Notify_Subscribe_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterNotifyHandlerClient(ctx context.Context, mux *runtime.ServeMux, client NotifyClient) error {
	...
	mux.Handle("POST", pattern_Notify_Subscribe_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/hvx.api.v1alpha1.notify.proto.Notify/Subscribe", runtime.WithHTTPPathPattern("/api/v1/notify/subscribe"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Notify_Subscribe_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
