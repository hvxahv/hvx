...
func request_Outbox_GetOutbox_0(ctx context.Context, marshaler runtime.Marshaler, client OutboxClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Outbox_GetOutbox_0(ctx context.Context, marshaler runtime.Marshaler, server OutboxServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetOutboxRequest
	var metadata runtime.ServerMetadata
...
// RegisterOutboxHandlerServer registers the http handlers for service Outbox to "mux".
// UnaryRPC     :call OutboxServer directly.
...
func RegisterOutboxHandlerServer(ctx context.Context, mux *runtime.ServeMux, server OutboxServer) error {
	...
	mux.Handle("GET", pattern_Outbox_GetOutbox_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_Outbox_GetOutbox_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_Outbox_GetOutbox_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("GET", pattern_Outbox_GetOutboxes_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/hvx.api.v1alpha1.activity.proto.Outbox/GetOutboxes", runtime.WithHTTPPathPattern("/api/v1/activity/outbox"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Outbox_GetOutboxes_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_Outbox_GetOutboxes_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
// RegisterOutboxHandlerFromEndpoint is same as RegisterOutboxHandler but
...
func RegisterOutboxHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterOutboxHandler(ctx, mux, conn)
}

// RegisterOutboxHandler registers the http handlers for service Outbox to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterOutboxHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterOutboxHandlerClient(ctx, mux, NewOutboxClient(conn))
}

// RegisterOutboxHandlerClient registers the http handlers for service Outbox
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "OutboxClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "OutboxClient"
...
func RegisterOutboxHandlerClient(ctx context.Context, mux *runtime.ServeMux, client OutboxClient) error {
	...
	mux.Handle("GET", pattern_Outbox_GetOutbox_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Outbox_GetOutbox_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_Outbox_GetOutboxes_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/hvx.api.v1alpha1.activity.proto.Outbox/GetOutboxes", runtime.WithHTTPPathPattern("/api/v1/activity/outbox"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Outbox_GetOutboxes_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	forward_Outbox_GetOutboxes_0 = runtime.ForwardResponseMessage
)
