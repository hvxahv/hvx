...
func request_Actor_Edit_0(ctx context.Context, marshaler runtime.Marshaler, client ActorClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Actor_Edit_0(ctx context.Context, marshaler runtime.Marshaler, server ActorServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq EditRequest
	var metadata runtime.ServerMetadata
...
// RegisterActorHandlerServer registers the http handlers for service Actor to "mux".
// UnaryRPC     :call ActorServer directly.
...
func RegisterActorHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ActorServer) error {
	...
	mux.Handle("GET", pattern_Actor_GetActorsByPreferredUsername_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/hvx.api.v1alpha1.actor.proto.Actor/GetActorsByPreferredUsername", runtime.WithHTTPPathPattern("/api/v1/search/{preferred_username}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Actor_GetActorsByPreferredUsername_0(ctx, inboundMarshaler, server, req, pathParams)
		...
		forward_Actor_GetActorsByPreferredUsername_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("PUT", pattern_Actor_Edit_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/hvx.api.v1alpha1.actor.proto.Actor/Edit", runtime.WithHTTPPathPattern("/api/v1/actor"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Actor_Edit_0(ctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_Actor_Edit_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
// RegisterActorHandlerFromEndpoint is same as RegisterActorHandler but
...
func RegisterActorHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterActorHandler(ctx, mux, conn)
}

// RegisterActorHandler registers the http handlers for service Actor to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterActorHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterActorHandlerClient(ctx, mux, NewActorClient(conn))
}

// RegisterActorHandlerClient registers the http handlers for service Actor
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "ActorClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "ActorClient"
...
func RegisterActorHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ActorClient) error {
	...
	mux.Handle("GET", pattern_Actor_GetActorsByPreferredUsername_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/hvx.api.v1alpha1.actor.proto.Actor/GetActorsByPreferredUsername", runtime.WithHTTPPathPattern("/api/v1/search/{preferred_username}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Actor_GetActorsByPreferredUsername_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("PUT", pattern_Actor_Edit_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/hvx.api.v1alpha1.actor.proto.Actor/Edit", runtime.WithHTTPPathPattern("/api/v1/actor"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Actor_Edit_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
