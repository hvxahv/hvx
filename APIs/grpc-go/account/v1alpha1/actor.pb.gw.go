...
func RegisterActorHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ActorServer) error {
	...
	mux.Handle("GET", pattern_Actor_GetActorsByPreferredUsername_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/hvx.account.v1alpha1.proto.Actor/GetActorsByPreferredUsername", runtime.WithHTTPPathPattern("/api/clientv1/search/{preferred_username}"))
		if err != nil {
...
func RegisterActorHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ActorClient) error {
	...
	mux.Handle("GET", pattern_Actor_GetActorsByPreferredUsername_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/hvx.account.v1alpha1.proto.Actor/GetActorsByPreferredUsername", runtime.WithHTTPPathPattern("/api/clientv1/search/{preferred_username}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Actor_GetActorsByPreferredUsername_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"api", "clientv1", "search", "preferred_username"}, ""))
)
