...
type AccountsClient interface {
	...
	GetActorByUsername(ctx context.Context, in *GetActorByUsernameRequest, opts ...grpc.CallOption) (*ActorDataResponse, error)
}
...
func (c *accountsClient) IsExist(ctx context.Context, in *IsExistRequest, opts ...grpc.CallOption) (*IsExistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hvx.account.v1alpha1.proto.Accounts/IsExist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountsClient) CreateAccount(ctx context.Context, in *CreateAccountRequest, opts ...grpc.CallOption) (*CreateAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hvx.account.v1alpha1.proto.Accounts/CreateAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountsClient) GetByUsername(ctx context.Context, in *GetByUsernameRequest, opts ...grpc.CallOption) (*GetByUsernameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hvx.account.v1alpha1.proto.Accounts/GetByUsername", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountsClient) DeleteAccount(ctx context.Context, in *DeleteAccountRequest, opts ...grpc.CallOption) (*DeleteAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hvx.account.v1alpha1.proto.Accounts/DeleteAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountsClient) EditUsername(ctx context.Context, in *EditUsernameRequest, opts ...grpc.CallOption) (*EditUsernameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hvx.account.v1alpha1.proto.Accounts/EditUsername", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountsClient) EditPassword(ctx context.Context, in *EditPasswordRequest, opts ...grpc.CallOption) (*EditPasswordResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hvx.account.v1alpha1.proto.Accounts/EditPassword", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountsClient) EditEmail(ctx context.Context, in *EditEmailRequest, opts ...grpc.CallOption) (*EditEmailResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hvx.account.v1alpha1.proto.Accounts/EditEmail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountsClient) GetActorByUsername(ctx context.Context, in *GetActorByUsernameRequest, opts ...grpc.CallOption) (*ActorDataResponse, error) {
	out := new(ActorDataResponse)
	err := c.cc.Invoke(ctx, "/hvx.account.v1alpha1.proto.Accounts/GetActorByUsername", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AccountsServer interface {
	...
	// GetActorByUsername Get by username returns the actor
	// identified by the specified username.
	GetActorByUsername(context.Context, *GetActorByUsernameRequest) (*ActorDataResponse, error)
}
...
func (UnimplementedAccountsServer) GetActorByUsername(context.Context, *GetActorByUsernameRequest) (*ActorDataResponse, error) {
...
func _Accounts_IsExist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hvx.account.v1alpha1.proto.Accounts/IsExist",
	}
...
func _Accounts_CreateAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hvx.account.v1alpha1.proto.Accounts/CreateAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Accounts_GetByUsername_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hvx.account.v1alpha1.proto.Accounts/GetByUsername",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Accounts_DeleteAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hvx.account.v1alpha1.proto.Accounts/DeleteAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Accounts_EditUsername_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hvx.account.v1alpha1.proto.Accounts/EditUsername",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Accounts_EditPassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hvx.account.v1alpha1.proto.Accounts/EditPassword",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Accounts_EditEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hvx.account.v1alpha1.proto.Accounts/EditEmail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Accounts_GetActorByUsername_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetActorByUsernameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccountsServer).GetActorByUsername(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hvx.account.v1alpha1.proto.Accounts/GetActorByUsername",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountsServer).GetActorByUsername(ctx, req.(*GetActorByUsernameRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Accounts_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "hvx.account.v1alpha1.proto.Accounts",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Accounts_GetActorByUsername_Handler,
		},
	},
