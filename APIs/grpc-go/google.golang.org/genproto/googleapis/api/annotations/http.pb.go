...
// HTTP | gRPC
// -----|-----
// `GET /clientv1/messages/123456`  | `GetMessage(name: "messages/123456")`
//
...
//       rpc GetMessage(GetMessageRequest) returns (Message) {
//         option (google.api.http) = {
//             get:"/clientv1/messages/{message_id}"
//         };
//       }
//     }
//     message GetMessageRequest {
...
// HTTP | gRPC
// -----|-----
// `GET /clientv1/messages/123456?revision=2&sub.subfield=foo` |
...
//         option (google.api.http) = {
//           patch: "/clientv1/messages/{message_id}"
//           body: "message"
//         };
//       }
//     }
...
// HTTP | gRPC
// -----|-----
// `PATCH /clientv1/messages/123456 { "text": "Hi!" }` | `UpdateMessage(message_id:
...
//           get: "/clientv1/messages/{message_id}"
//           additional_bindings {
//             get: "/clientv1/users/{user_id}/messages/{message_id}"
//           }
//         };
//       }
//     }
...
// HTTP | gRPC
// -----|-----
// `GET /clientv1/messages/123456` | `GetMessage(message_id: "123456")`
// `GET /clientv1/users/me/messages/123456` | `GetMessage(user_id: "me" message_id:
// "123456")`
//
...
//         - selector: example.clientv1.Messaging.GetMessage
//           get: /clientv1/messages/{message_id}/{sub.subfield}
//
// ## Special notes
//
