...
func (c *administrativeClient) IsChannelAdministrator(ctx context.Context, in *IsChannelAdministratorRequest, opts ...grpc.CallOption) (*IsChannelAdministratorResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hvx.channel.v1alpha1.proto.Administrative/IsChannelAdministrator", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *administrativeClient) AddAdministrator(ctx context.Context, in *AddAdministratorRequest, opts ...grpc.CallOption) (*AddAdministratorResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hvx.channel.v1alpha1.proto.Administrative/AddAdministrator", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *administrativeClient) RemoveAdministrator(ctx context.Context, in *RemoveAdministratorRequest, opts ...grpc.CallOption) (*RemoveAdministratorResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hvx.channel.v1alpha1.proto.Administrative/RemoveAdministrator", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *administrativeClient) GetAdministrators(ctx context.Context, in *GetAdministratorsRequest, opts ...grpc.CallOption) (*GetAdministratorsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hvx.channel.v1alpha1.proto.Administrative/GetAdministrators", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Administrative_IsChannelAdministrator_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hvx.channel.v1alpha1.proto.Administrative/IsChannelAdministrator",
	}
...
func _Administrative_AddAdministrator_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hvx.channel.v1alpha1.proto.Administrative/AddAdministrator",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Administrative_RemoveAdministrator_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hvx.channel.v1alpha1.proto.Administrative/RemoveAdministrator",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Administrative_GetAdministrators_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hvx.channel.v1alpha1.proto.Administrative/GetAdministrators",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Administrative_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "hvx.channel.v1alpha1.proto.Administrative",
