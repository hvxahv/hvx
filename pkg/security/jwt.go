...
func NewClaims(mail, username, password string) *Claims {
...
func GenToken(mail, username, password string) (string, error) {
	t := jwt.NewWithClaims(jwt.SigningMethodHS256, NewClaims(mail, username, password))
