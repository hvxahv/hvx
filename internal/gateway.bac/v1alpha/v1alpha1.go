...
import (
	...
	"github.com/hvxahv/hvx/internal/gateway.bac/handler"
)
...
func V1Accounts(v1 *gin.RouterGroup) {
	...
	/**
	 * Account for v1 version of the server api endpoints for the account resource type (gateway.bac.hvxahv.com/v1/account).
	 */
	v1.GET("/account/iam")
	...
	/**
	 * Actor for v1 version of the server api endpoints for the account resource type (gateway.bac.hvxahv.com/v1/actor).
	 */
	v1.PATCH("/actor/edit")

	/**
	 * ECDH for v1 version of the server api endpoints for the account resource type (gateway.bac.hvxahv.com/v1/dh).
	 */
