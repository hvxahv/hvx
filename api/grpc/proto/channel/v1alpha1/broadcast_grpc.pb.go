...
func (c *broadcastClient) CreateBroadcast(ctx context.Context, in *CreateBroadcastRequest, opts ...grpc.CallOption) (*CreateBroadcastResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hvxahv.v1alpha1.proto.Broadcast/CreateBroadcast", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *broadcastClient) GetAllBroadcasts(ctx context.Context, in *GetAllBroadcastsRequest, opts ...grpc.CallOption) (*GetAllBroadcastsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hvxahv.v1alpha1.proto.Broadcast/GetAllBroadcasts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *broadcastClient) DeleteBroadcast(ctx context.Context, in *DeleteBroadcastRequest, opts ...grpc.CallOption) (*DeleteBroadcastResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hvxahv.v1alpha1.proto.Broadcast/DeleteBroadcast", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Broadcast_CreateBroadcast_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hvxahv.v1alpha1.proto.Broadcast/CreateBroadcast",
	}
...
func _Broadcast_GetAllBroadcasts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hvxahv.v1alpha1.proto.Broadcast/GetAllBroadcasts",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Broadcast_DeleteBroadcast_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hvxahv.v1alpha1.proto.Broadcast/DeleteBroadcast",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Broadcast_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "hvxahv.v1alpha1.proto.Broadcast",
