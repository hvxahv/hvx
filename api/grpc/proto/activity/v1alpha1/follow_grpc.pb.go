...
func (c *followClient) CreateFollow(ctx context.Context, in *CreateFollowRequest, opts ...grpc.CallOption) (*CreateFollowResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hvxahv.v1alpha1.proto.Follow/CreateFollow", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *followClient) GetFollowers(ctx context.Context, in *GetFollowersRequest, opts ...grpc.CallOption) (*GetFollowersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hvxahv.v1alpha1.proto.Follow/GetFollowers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *followClient) GetFollowing(ctx context.Context, in *GetFollowingRequest, opts ...grpc.CallOption) (*GetFollowingResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hvxahv.v1alpha1.proto.Follow/GetFollowing", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Follow_CreateFollow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hvxahv.v1alpha1.proto.Follow/CreateFollow",
	}
...
func _Follow_GetFollowers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hvxahv.v1alpha1.proto.Follow/GetFollowers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Follow_GetFollowing_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hvxahv.v1alpha1.proto.Follow/GetFollowing",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Follow_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "hvxahv.v1alpha1.proto.Follow",
