...
type DevicesClient interface {
	...
	GetDeviceByID(ctx context.Context, in *NewDeviceID, opts ...grpc.CallOption) (*DeviceData, error)
...
func (c *devicesClient) GetDeviceByID(ctx context.Context, in *NewDeviceID, opts ...grpc.CallOption) (*DeviceData, error) {
	out := new(DeviceData)
...
type DevicesServer interface {
	...
	GetDeviceByID(context.Context, *NewDeviceID) (*DeviceData, error)
...
func (UnimplementedDevicesServer) GetDeviceByID(context.Context, *NewDeviceID) (*DeviceData, error) {
...
func _Devices_GetDeviceByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DevicesServer).GetDeviceByID(ctx, req.(*NewDeviceID))
	}
	return interceptor(ctx, in, info, handler)
}
