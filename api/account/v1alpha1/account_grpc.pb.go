...
type ECDHClient interface {
	...
	DHRequestEncryption(ctx context.Context, in *NewDHRequestEncryption, opts ...grpc.CallOption) (*DHEncryptionReply, error)
	DHGetPublic(ctx context.Context, in *NewDHGetPublic, opts ...grpc.CallOption) (*DHGetPublicReply, error)
	DHSendEncryption(ctx context.Context, in *NewDHSendEncryption, opts ...grpc.CallOption) (*DHEncryptionReply, error)
	DHWaitEncryption(ctx context.Context, in *NewDHWaitEncryption, opts ...grpc.CallOption) (*DHWaitEncryptionReply, error)
}
...
func (c *eCDHClient) DHRequestEncryption(ctx context.Context, in *NewDHRequestEncryption, opts ...grpc.CallOption) (*DHEncryptionReply, error) {
	out := new(DHEncryptionReply)
	err := c.cc.Invoke(ctx, "/hvxahv.v1alpha1.proto.ECDH/DHRequestEncryption", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eCDHClient) DHGetPublic(ctx context.Context, in *NewDHGetPublic, opts ...grpc.CallOption) (*DHGetPublicReply, error) {
	out := new(DHGetPublicReply)
	err := c.cc.Invoke(ctx, "/hvxahv.v1alpha1.proto.ECDH/DHGetPublic", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eCDHClient) DHSendEncryption(ctx context.Context, in *NewDHSendEncryption, opts ...grpc.CallOption) (*DHEncryptionReply, error) {
	out := new(DHEncryptionReply)
	err := c.cc.Invoke(ctx, "/hvxahv.v1alpha1.proto.ECDH/DHSendEncryption", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eCDHClient) DHWaitEncryption(ctx context.Context, in *NewDHWaitEncryption, opts ...grpc.CallOption) (*DHWaitEncryptionReply, error) {
	out := new(DHWaitEncryptionReply)
	err := c.cc.Invoke(ctx, "/hvxahv.v1alpha1.proto.ECDH/DHWaitEncryption", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ECDHServer interface {
	// Get the Diffie-Hellman parameter and use the requested logged-in device as the cache key
	DHRequestEncryption(context.Context, *NewDHRequestEncryption) (*DHEncryptionReply, error)
	DHGetPublic(context.Context, *NewDHGetPublic) (*DHGetPublicReply, error)
	DHSendEncryption(context.Context, *NewDHSendEncryption) (*DHEncryptionReply, error)
	DHWaitEncryption(context.Context, *NewDHWaitEncryption) (*DHWaitEncryptionReply, error)
...
func (UnimplementedECDHServer) DHRequestEncryption(context.Context, *NewDHRequestEncryption) (*DHEncryptionReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DHRequestEncryption not implemented")
}
func (UnimplementedECDHServer) DHGetPublic(context.Context, *NewDHGetPublic) (*DHGetPublicReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DHGetPublic not implemented")
}
func (UnimplementedECDHServer) DHSendEncryption(context.Context, *NewDHSendEncryption) (*DHEncryptionReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DHSendEncryption not implemented")
}
func (UnimplementedECDHServer) DHWaitEncryption(context.Context, *NewDHWaitEncryption) (*DHWaitEncryptionReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DHWaitEncryption not implemented")
}
...
func _ECDH_DHRequestEncryption_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NewDHRequestEncryption)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ECDHServer).DHRequestEncryption(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hvxahv.v1alpha1.proto.ECDH/DHRequestEncryption",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ECDHServer).DHRequestEncryption(ctx, req.(*NewDHRequestEncryption))
	}
	return interceptor(ctx, in, info, handler)
}

func _ECDH_DHGetPublic_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NewDHGetPublic)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ECDHServer).DHGetPublic(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hvxahv.v1alpha1.proto.ECDH/DHGetPublic",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ECDHServer).DHGetPublic(ctx, req.(*NewDHGetPublic))
	}
	return interceptor(ctx, in, info, handler)
}

func _ECDH_DHSendEncryption_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NewDHSendEncryption)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ECDHServer).DHSendEncryption(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hvxahv.v1alpha1.proto.ECDH/DHSendEncryption",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ECDHServer).DHSendEncryption(ctx, req.(*NewDHSendEncryption))
	}
	return interceptor(ctx, in, info, handler)
}

func _ECDH_DHWaitEncryption_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NewDHWaitEncryption)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ECDHServer).DHWaitEncryption(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hvxahv.v1alpha1.proto.ECDH/DHWaitEncryption",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ECDHServer).DHWaitEncryption(ctx, req.(*NewDHWaitEncryption))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ECDH_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "DHRequestEncryption",
			Handler:    _ECDH_DHRequestEncryption_Handler,
		},
		{
			MethodName: "DHGetPublic",
			Handler:    _ECDH_DHGetPublic_Handler,
		},
		{
			MethodName: "DHSendEncryption",
			Handler:    _ECDH_DHSendEncryption_Handler,
		},
		{
			MethodName: "DHWaitEncryption",
			Handler:    _ECDH_DHWaitEncryption_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/account/v1alpha1/account.proto",
