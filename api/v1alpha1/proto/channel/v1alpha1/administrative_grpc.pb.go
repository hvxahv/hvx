...
// All implementations should embed UnimplementedAdministrativeServiceServer
...
// UnimplementedAdministrativeServiceServer should be embedded to have forward compatible implementations.
